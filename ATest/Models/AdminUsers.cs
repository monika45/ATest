...
namespace ATest.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "admin_users")]
	public partial class AdminUsers {
		...
		[JsonProperty, Column(Name = "password", DbType = "varchar(60)")]
		public string Password { get; set; } = string.Empty;

		[JsonProperty, Column(Name = "remember_token", DbType = "varchar(100)")]
		public string RememberToken { get; set; } = string.Empty;

		[JsonProperty, Column(Name = "updated_at", DbType = "timestamp")]
		public DateTime? UpdatedAt { get; set; }

		[JsonProperty, Column(Name = "username", DbType = "varchar(190)")]
